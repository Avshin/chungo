        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-element-list">
                    ...
                    <form action="<% out.print(getServletContext().getContextPath());%>/PersonaSRV" method="POST">
                        <div class="row">
                            <!--ID -->
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" data-mask="99999999" placeholder="CEDULA" id="cedula">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <center>
                            ...
                            <form action="<% out.print(getServletContext().getContextPath());%>/PersonaSRV" method="POST">
                                <table class="table table-hover">
                                    ...
                                    <tbody class="buscador" id="id_tablaPersona">
                                    </tbody>
