        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-element-list">
                    ...
                    <form action="<% out.print(getServletContext().getContextPath());%>/dependenciasSRV" method="POST" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group ic-cmp-int">
                                        ...
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control" disabled="" placeholder="ID" id="id_dependencia">
                                        </div>
                                    </div>
                                </div>
                                <!-- DETALLE -->
